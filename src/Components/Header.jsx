...
export default function Header({ liveCount }) {
  return (
    <header className="sticky top-0 z-40 w-full bg-darkbg/80 backdrop-blur-md border-b border-[#121212] px-4 py-3 flex items-center justify-between">
      {/* Brand logo & title */}
      ...
      <div className="flex items-center space-x-3">
        {liveCount > 0 && (
          <div className="flex items-center space-x-1.5 bg-[#f57c00]/10 border border-[#f57c00]/35 px-2.5 py-1 rounded-full animate-pulse-slow">
        ...
        <div className="w-8 h-8 rounded-full border border-basketball/40 overflow-hidden bg-[#0d0d0d] flex items-center justify-center">
